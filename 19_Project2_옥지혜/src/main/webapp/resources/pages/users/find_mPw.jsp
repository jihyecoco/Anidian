...
function registerCheck(){
	...
	//test() : 찾는 문자열이, 들어있는지 아닌지를 boolean으로 리턴.
 	if( !getAccount.test($('input[name=userId]').val()) ){ //아이디 유효성검사
        alert("ID는 5~12자의 영문 대소문자와 숫자로만 구성되어있습니다. ");   
			...
			<div class="row w-100 mx-0">
				<div class="col-lg-9 mx-auto">
					<div class="auth-form-light text-left py-5 px-4 px-sm-5">
						...
						<h4 >비밀번호찾기</h4>
						<!-- 비밀번호찾기 form -->
						<form class="pt-3" method="post" action="find_mPwProc.jsp" onsubmit="return registerCheck()">
							<!-- USERID -->
